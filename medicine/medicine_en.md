...
| Medical SAM Adapter | Medical SAM Adapter: Adapting Segment Anything Model for Medical Image Segmentation | Adapter-based approach to adapt SAM for medical image segmentation while preserving SAM's original capabilities. | [Medical Image Analysis](https://doi.org/10.1016/j.media.2025.103547) |
...
| GPT-RadPlan | Automated Radiotherapy Treatment Planning Guided by GPT-4Vision | Fully automated radiotherapy planning system leveraging GPT-4Vision's multimodal reasoning to simulate a human planner's clinical decision-making. | [Physics in Medicine &amp; Biology](https://doi.org/10.1088/1361-6560/adf02c) |
