...
| MIST | Foundation Models for Discovery and Exploration in Chemical Space | Alexius Wadell | 2025 | arXiv:2510.18900 | arXiv | 大规模分子基础模型家族（分子洞察SMILES Transformer），在海量无标注分子上训练，预测400+结构-属性关系 |
| M2UMol | Multi-to-uni modal knowledge transfer pre-training for molecular representation learning | Zhankun Xiong | 2026 | 10.1038/s41467-026-69302-6 | Nature Communications | 多模态到单模态知识迁移预训练框架，将多模态分子知识蒸馏到2D编码器 |
...
| 模型名称 | 论文标题 | 第一作者 | 年份 | ArXiv/DOI | 发表venue | 简述 |
|---------|---------|---------|------|-----------|----------|------|
| Molecular Transformer | Molecular Transformer: A Model for Uncertainty-Calibrated Chemical Reaction Prediction | Philippe Schwaller | 2019 | 10.1021/acscentsci.9b00576 | ACS Central Science | 开创性seq2seq Transformer，将化学反应预测框架为SMILES翻译任务，含不确定性校准 |
...
| RXNFP | Mapping the space of chemical reactions using attention-based neural networks | Philippe Schwaller | 2021 | 10.1038/s42256-020-00284-w | Nature Machine Intelligence | IBM开发的Transformer模型，学习化学反应指纹，用于反应分类和反应空间映射 |
...
| LocalRetro | Deep Retrosynthetic Reaction Prediction using Local Reactivity and Global Attention | Shuan Chen | 2021 | 10.1021/jacsau.1c00246 | JACS Au | 强调局部化学反应性和全局注意力的深度学习逆合成框架，在半模板方法中达到SOTA |
...
| Umol | Structure prediction of protein-ligand complexes from sequence information with Umol | Patrick Bryant | 2024 | 10.1038/s41467-024-48837-6 | Nature Communications | 仅从氨基酸序列和SMILES预测全柔性全原子蛋白-配体复合物结构的AI系统 |
...
| cMolGPT | cMolGPT: A Conditional Generative Pre-Trained Transformer for Target-Specific De Novo Molecular Generation | Ye Wang | 2023 | 10.3390/molecules28114430 | Molecules | 条件分子GPT，扩展MolGPT增加靶标特定控制，用于从头分子生成 |
