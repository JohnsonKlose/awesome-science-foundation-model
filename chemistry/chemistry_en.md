...
| GemNet-OC | GemNet-OC: Developing Graph Neural Networks for Large and Diverse Molecular Simulation Datasets | GemNet variant optimized for the Open Catalyst large-scale dataset with improved computational efficiency and generalization. | [TMLR](https://arxiv.org/abs/2204.02782) |
