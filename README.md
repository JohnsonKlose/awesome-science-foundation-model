...
| MSA Transformer | MSA Transformer | Transformer model that operates over multiple sequence alignments for improved protein modeling. | [ICML](https://proceedings.mlr.press/v139/rao21a.html)                                        |
...
| ProteinSage | ProteinSage: From implicit learning to explicit structural constraints for efficient protein language modeling | Protein language model combining implicit learning with explicit structural constraints for improved efficiency. | [bioRxiv](https://www.biorxiv.org/content/10.64898/2026.03.17.712034) |
...
| ECNet | ECNet is an evolutionary context-integrated deep learning framework for protein engineering | Deep learning framework integrating evolutionary context for protein engineering and fitness prediction. | [Nature Communications](https://doi.org/10.1038/s41467-021-25976-8)                      |
...
| AgroNT | A foundational large language model for edible plant genomes | Crop-specific genomic foundation model for plant genomics and breeding applications. | [Communications Biology](https://doi.org/10.1038/s42003-024-06465-2) |
...
| C2S-Scale | Scaling large language models for next-generation single-cell analysis | Scales the Cell2Sentence framework with larger models and broader data for improved single-cell RNA-seq analysis. | [bioRxiv](https://doi.org/10.1101/2025.04.14.648850) |
...
| TOSICA | Transformer for one stop interpretable cell type annotation | Transfer learning framework for single-cell omics analysis across datasets and modalities. | [Nature Communications](https://doi.org/10.1038/s41467-023-35923-4) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| CpGPT | CpGPT: a Foundation Model for DNA Methylation | DNA methylation foundation model predicting CpG site methylation states for aging and disease research. | [bioRxiv](https://www.biorxiv.org/content/10.1101/2024.10.24.619766) |
...
| TNO | Transolver / Transformer Neural Operator | Transformer-based neural operator for PDEs on complex geometries and irregular grids. | [ICML 2024](https://proceedings.mlr.press/v235/wu24r.html)                                                                   |
...
| SuPreM | Towards Foundation Models and Few-Shot Parameter-Efficient Fine-Tuning for Volumetric Organ Segmentation | Supervised pretrained 3D segmentation foundation model trained on 2,100+ CT scans. | [arXiv](https://arxiv.org/abs/2303.17051) |
...
| 3DINO | A generalizable 3D framework and model for self-supervised learning in medical imaging | Self-supervised 3D anatomical representation learning. | [arXiv](https://arxiv.org/abs/2501.11755) |
| DeepMedix-R1 | A Foundation Model for Chest X-ray Interpretation with Grounded Reasoning via Online Reinforcement Learning | Reasoning-enhanced medical imaging foundation model. | [GitHub](https://github.com/DeepReasoning/DeepMedix-R1) |
...
| H-optimus-0 | H-optimus-0: An Open-Source AI Foundation Model for Pathology | World's largest open-source pathology AI foundation model (1.1B parameters) trained on 500,000+ WSIs, developed by Bioptimus. | [GitHub](https://github.com/bioptimus/releases/tree/main/models/h-optimus/v0) |
...
| Atlas | Atlas: A Novel Pathology Foundation Model by Mayo Clinic, Charité, and Aignostics | Whole-slide level pathology foundation model. | [arXiv](https://arxiv.org/abs/2501.05409) |
...
| PathOrchestra | PathOrchestra: a comprehensive foundation model for computational pathology | Comprehensive computational pathology foundation model covering multiple pathology tasks. | [npj Digital Medicine](https://doi.org/10.1038/s41746-025-02027-w) |
...
| RudolfV | RudolfV: A Foundation Model by Pathologists for Pathologists | Foundation model connecting pathology images and genomic sequences. | [arXiv](https://arxiv.org/abs/2401.04079) |
...
| GPFM | Towards A Generalizable Pathology Foundation Model via Unified Knowledge Distillation | Generalizable pathology foundation model trained on 190K+ WSIs. | [arXiv](https://arxiv.org/abs/2407.18449) |
...
| PathoDuet | PathoDuet: Foundation Models for Pathological Slide Analysis of H&E and IHC Stains | Dual-scale self-supervised pathology foundation model. | [arXiv](https://arxiv.org/abs/2312.09894) |
...
| MADELEINE | Multistain Pretraining for Slide Representation Learning in Pathology | Multimodal adaptive pathology learning with integrated embeddings. | [arXiv](https://arxiv.org/abs/2408.02859) |
| Lunit-DINO | Benchmarking Self-Supervised Learning on Diverse Pathology Datasets | Lunit's DINOv2-based large-scale pathology pretraining. | [arXiv](https://arxiv.org/abs/2212.04690) |
...
| GigaTIME | Multimodal AI generates virtual population for tumor microenvironment modeling | Multimodal AI framework generating virtual multiplex immunofluorescence from H&E slides, trained on 40M paired cells across 21 proteins and applied to 14,000+ patients spanning 24 cancer types for population-scale tumor immune microenvironment profiling. | [Cell](https://doi.org/10.1016/j.cell.2025.11.016) |
...
| LongViT | When an Image is Worth 1,024 x 1,024 Words: A Case Study in Computational Pathology | Long-context vision Transformer directly processing ultra-large pathology whole-slide images. | [arXiv](https://arxiv.org/abs/2312.03558) |
| Pixel-Mamba | From Pixels to Gigapixels: Bridging Local Inductive Bias and Long-Range Dependencies for Whole Slide Imaging | Efficient Mamba architecture-based computational pathology foundation model with pixel-level processing. | [arXiv](https://arxiv.org/abs/2412.16711) |
...
| CSFM | Cardiac health assessment across scenarios and devices using a multimodal foundation model pretrained on data from 1.7 million individuals | Multimodal cardiac sensing foundation model pretrained on ECG/PPG signals and clinical text from 1.7M individuals for diagnosis, vital sign measurement, and clinical outcome prediction. | [Nat. Mach. Intell.](https://doi.org/10.1038/s42256-026-01180-5) |
...
| MathCoder | MathCoder: Seamless Code Integration in LLMs for Enhanced Mathematical Reasoning | A model series enhancing LLM mathematical reasoning through seamless code integration, fine-tuned on the MathCodeInstruct dataset. | [ICLR 2024](https://openreview.net/forum?id=z8TW0ttBPp)                                                                      |
