...
| Clay Foundation Model | Clay: An Open Source AI Model for Earth | An open-source earth observation foundation model based on masked autoencoder architecture supporting Sentinel-1/2 and DEM data. | [Open Source](https://clay-foundation.github.io/model/) |
