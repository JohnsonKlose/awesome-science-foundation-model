...
Pure datasets, benchmarks, challenges, libraries, and product-only release pages have been removed from the catalog.
...
| ProGen3 | Scaling Unlocks Broader Generation and Deeper Functional Understanding of Proteins | Sparse mixture-of-experts protein generative model trained on 1.5 trillion tokens for enhanced protein design. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.04.15.649055) |
| SaProt | SaProt: Protein language modeling with structure-aware vocabulary | Structure-aware protein language model that encodes 3D structures as discrete tokens via Foldseek for joint training with sequences. | [ICLR 2024](https://openreview.net/forum?id=6MRm3G4NiU) |
...
| ProCyon | ProCyon: A multimodal foundation model for protein phenotypes | Multimodal protein foundation model integrating sequence, structure, and natural language data to predict protein phenotypes. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.12.10.627665) |
| ProSST | ProSST: Protein Language Modeling with Quantized Structure and Disentangled Attention | Protein language model combining amino acid sequences with quantized 3D structural information. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.04.15.589672) |
...
| ProtWord | ProtWord: A Discrete Protein Language Model for Functional Discovery and De Novo Design | 150M-parameter discrete protein language model that translates sequences into an 8,192-token vocabulary for functional discovery. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.64898/2026.02.14.705947) |
| ProtLLM | ProtLLM: An Interleaved Protein-Language LLM with Protein-as-Word Pre-Training | Interleaved protein-language large language model with a dynamic protein mounting mechanism. | [ACL Anthology](https://aclanthology.org/2024.acl-long.484/) |
...
| PoET | PoET: A generative model of protein families as sequences-of-sequences | Sequences-of-sequences family modeling framework with retrieval for protein fitness prediction. | [NeurIPS](https://proceedings.neurips.cc/paper_files/paper/2023/hash/f4366126eba252699b280e8f93c0ab2f-Abstract-Conference.html) |
...
| ProteinSage | ProteinSage: From implicit learning to explicit structural constraints for efficient protein language modeling | Protein language model combining implicit learning with explicit structural constraints for improved efficiency. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.64898/2026.03.17.712034) |
...
| PoET-2 | Understanding protein function with a multimodal retrieval-augmented foundation model | Next-generation retrieval-augmented multimodal protein family model improving fitness prediction over PoET. | [arXiv](https://arxiv.org/abs/2508.04724) |
| FlexRibbon | FlexRibbon: Joint Sequence and Structure Pretraining for Protein Modeling | 3-billion-parameter model jointly pretrained on amino acid sequences and 3D structures capturing flexible conformations. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.10.08.681293) |
...
| MIF | Masked inverse folding with sequence transfer for protein representation learning | Self-supervised masked inverse folding pretraining for learning protein representations from structures. | [Protein Engineering Design and Selection](https://doi.org/10.1093/protein/gzad015) |
...
| RoseTTAFold2 | Efficient and accurate prediction of protein structure using RoseTTAFold2 | Upgraded RoseTTAFold combining key features from AlphaFold2 and the original RoseTTAFold. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2023.05.24.542179) |
...
| OmegaFold | High-resolution de novo structure prediction from primary sequence | MSA-free single-sequence protein structure prediction leveraging pretrained protein language models. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2022.07.21.500999) |
...
| Proteus | Proteus: Exploring Protein Structure Generation for Enhanced Designability and Efficiency | Efficient protein backbone generation model without requiring pretrained structure prediction networks. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.02.10.579791) |
...
| ESM-IF (ESM-IF1) | Language models generalize beyond natural proteins | Inverse folding model conditioned on backbone structures for generating protein sequences. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2022.12.21.521521) |
| EvoDiff | Protein generation with evolutionary diffusion | Sequence-based diffusion model for protein generation leveraging evolutionary data. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2023.09.11.556673) |
| ZymCTRL | Conditional language models enable the efficient design of proficient enzymes | Conditional enzyme language model trained on 37 million BRENDA enzyme sequences. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.05.03.592223) |
...
| LM-Design | Structure-informed Language Models Are Protein Designers | Structure-informed language model for protein design combining PLM and structural context. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2023.02.03.526917) |
...
| TERMinator | TERMinator: A neural framework for structure-based protein design using tertiary repeating motifs | Neural network framework for protein design based on tertiary repeating motifs. | [arXiv](https://arxiv.org/abs/2204.13048) |
| ProteinMCP | ProteinMCP: An Agentic AI Framework for Autonomous Protein Engineering | Agentic AI framework integrating 38 specialized tools through MCP for autonomous protein engineering. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.64898/2026.03.11.711149) |
...
| ProDiT | Generating functional proteins with a multimodal diffusion transformer | Multimodal diffusion Transformer protein design model trained on 214 million proteins. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.09.03.672144) |
...
| PXDesign | PXDesign: Fast De Novo Design of Protein Binders | ByteDance Protenix fast and modular pipeline for de novo protein binder design with 20–73% hit rates. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.08.15.670450) |
...
| PepBERT | PepBERT: Lightweight language models for peptide representation | Lightweight dedicated peptide language model for bioactive peptide discovery and representation learning. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.04.08.647838) |
...
| AMP-Diffusion | AMP-Diffusion: Integrating Latent Diffusion with Protein Language Models for Antimicrobial Peptide Generation | Latent diffusion model integrated with ESM-2 for generating novel antimicrobial peptides. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.03.03.583201) |
...
| SeqDance | Learning Biophysical Dynamics with Protein Language Models | Protein language model incorporating biophysical dynamics, trained on MD simulations and normal mode analyses of 64,000+ proteins. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.10.11.617911) |
| ESMDance | Learning Biophysical Dynamics with Protein Language Models | ESM-2 fine-tuned variant for protein conformational dynamics prediction. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.10.11.617911) |
...
| DynamicsPLM | Learning Protein Representations with Conformational Dynamics | Protein language model learning from computationally generated conformational dynamics ensembles. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.10.06.680789) |
...
| UNI-RNA | UNI-RNA: UNIVERSAL PRE-TRAINED MODELS REVOLUTIONIZE RNA RESEARCH | Universal pretrained RNA model trained on the largest RNA sequence dataset supporting multiple downstream tasks. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2023.07.11.548588) |
...
| AIDO.RNA | A Large-Scale Foundation Model for RNA Function and Structure Prediction | 1.6-billion-parameter RNA foundation model trained on 42 million non-coding RNA sequences at single-nucleotide resolution. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.11.28.625345) |
...
| CodonBERT | CodonBERT: Large Language Models for mRNA design and optimization | Codon-level tokenized mRNA language model for mRNA design and optimization. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2023.09.09.556981) |
| NucleicBERT | NucleicBERT: A large language model for RNA structure prediction | BERT-based self-supervised masked language model for RNA sequence analysis and structure prediction. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.09.02.673754) |
...
| structRFM | A fully-open structure-guided RNA foundation model for robust structural and functional inference | Fully open-source structure-guided RNA foundation model integrating sequence and secondary structure for robust inference. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.08.06.668731) |
| SpliceBERT | SpliceBERT: a pre-trained RNA language model for analyzing vertebrate splicing | Pretrained RNA language model specialized for splicing analysis in vertebrates. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2023.01.31.526427) |
...
| AllSplice | Perturbation-aware predictive modeling of RNA splicing using bidirectional transformers | Perturbation-aware bidirectional transformer for RNA splicing prediction. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.03.20.585793) |
...
| CodonFM | Codon FM: Foundation Models for Codon Sequences | Codon foundation model trained on 130 million protein-coding sequences across 20,000+ species by NVIDIA and Arc Institute. | [Preprint](https://research.nvidia.com/labs/dbr/assets/data/manuscripts/nv-codonfm-preprint.pdf) |
| Orthrus | Orthrus: Evolutionary and Functional RNA Foundation Models | Mamba-based RNA foundation model pretrained with biologically-augmented contrastive learning. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.10.10.617658) |
...
| DRfold2 | Ab initio RNA structure prediction with composite language model and denoised end-to-end learning | Deep learning framework for ab initio RNA 3D structure prediction using a composite language model. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.03.05.641632) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| RNAGenesis | RNAGenesis: A Generalist Foundation Model for Functional RNA Therapeutics | Generalist RNA therapeutics foundation model unifying sequence representation, structure prediction, and functional de novo design. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.12.30.630826) |
...
| GenSLMs | GenSLMs: Genome-scale language models reveal SARS-CoV-2 evolutionary dynamics | Genome-scale language model pretrained on 110 million prokaryotic gene sequences analyzing SARS-CoV-2 evolution (Gordon Bell Prize). | [IJHPCA](https://doi.org/10.1177/10943420231201154) |
...
| Nucleotide Transformer v3 (NTv3) | A foundational model for joint sequence-function multi-species prediction | Multi-species long-range genomic prediction and functional annotation foundation model from InstaDeep. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.64898/2025.12.22.695963) |
| Basenji | Sequential regulatory activity prediction across chromosomes with convolutional neural networks | CNN for predicting gene expression and regulatory activity from DNA sequences. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/gr.227819.117) |
...
| ChromBPNet | ChromBPNet: bias factorized, base-resolution deep learning models of chromatin accessibility reveal cis-regulatory sequence syntax, transcription factor footprints and regulatory variants | Base-resolution deep learning model for chromatin accessibility prediction with bias factorization. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.12.25.630221) |
...
| EpiGePT | EpiGePT: a Pretrained Transformer model for epigenomics | Pretrained transformer model for epigenomics data analysis and prediction. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2023.07.15.549134) |
...
| BOTANIC-0 | BOTANIC-0: a series of foundation models for plant genomic data | Family of plant genomic foundation models (100M–1B parameters) pretrained on 1,600+ curated plant genomes. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.64898/2026.02.23.706817) |
| PlantCAD2 / GeneCAD | PlantCAD2: A Long-Context DNA Language Model for Cross-Species Functional Annotation | Long-context plant-specific DNA language model pretrained on 65 angiosperm genomes for cross-species functional annotation. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.08.27.672609) |
...
| Species-aware DNA LM | Species-aware DNA Language Modeling | DNA language model incorporating species-specific information during pretraining. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2023.01.26.525670) |
| Genos | Genos: a human-centric genomic foundation model | Large-scale (up to 10B parameters) human-centric genomic foundation model with MoE-Transformer architecture from BGI. | [GigaScience](https://academic.oup.com/gigascience/article/doi/10.1093/gigascience/giaf132/8373643?searchresult=1) |
...
| UCE | Universal Cell Embeddings: A Foundation Model for Cell Biology | Universal cell embedding model that creates a unified representation space across species and tissues. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2023.11.28.568918) |
...
| GenePT | GenePT: A Simple But Effective Foundation Model for Genes and Cells Built From ChatGPT | Simple and effective gene/cell foundation model using ChatGPT embeddings for gene and cell representation. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2023.10.16.562533) |
...
| scELMo | scELMo: Embeddings from Language Models are Good Learners for Single-cell Data Analysis | Language model embeddings applied to single-cell data analysis. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2023.12.07.569910) |
...
| xTrimoGene | xTrimoGene: An Efficient and Scalable Representation Learner for Single-Cell RNA-Seq Data | Efficient and scalable representation learner for scRNA-seq data using asymmetric encoder-decoder architecture. | [NeurIPS 2023](https://openreview.net/forum?id=gdwcoBCMVi) |
| CancerFoundation | A single-cell RNA sequencing foundation model to decipher drug resistance in cancer | Cancer-specific scRNA-seq foundation model for deciphering drug resistance mechanisms. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.11.01.621087) |
...
| Tahoe-x1 | Tahoe-x1: Scaling Perturbation-Trained Single-Cell Foundation Models to 3 Billion Parameters | 3B-parameter perturbation-trained single-cell foundation model for predicting cellular responses. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.10.23.683759) |
| PULSAR | PULSAR: a Foundation Model for Multi-scale and Multicellular Biology | Multi-scale foundation model integrating 36M+ cells for multicellular biology analysis. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.11.24.685470) |
| TranscriptFormer | A Cross-Species Generative Cell Atlas Across 1.5 Billion Years of Evolution | Cross-species generative cell atlas foundation model spanning 1.5 billion years of evolution. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.04.25.650731) |
| CELLama | CELLama: Foundation Model for Single Cell and Spatial Transcriptomics | Cell embedding model leveraging language model capabilities for single-cell and spatial transcriptomics. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.05.08.593094) |
...
| Tabula | Tabula: A Tabular Self-Supervised Foundation Model for Single-Cell Transcriptomics | Tabular self-supervised foundation model tailored for single-cell transcriptomics data. | [NeurIPS 2025](https://neurips.cc/virtual/2025/poster/117659) |
...
| EpiFoundation | EpiFoundation: A Foundation Model for Single-Cell ATAC-seq via Peak-to-Gene Alignment | Foundation model for scATAC-seq using peak-to-gene alignment for epigenomic analysis. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.02.05.636688) |
| SCARF | SCARF: Single Cell ATAC-seq and RNA-seq Foundation model | Multi-modal foundation model jointly modeling scATAC-seq and scRNA-seq data. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.04.07.647689) |
| CAPTAIN | CAPTAIN: A multimodal foundation model pretrained on co-assayed single-cell RNA and protein | Multimodal foundation model for co-assayed scRNA and protein data integration. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.07.07.663366) |
| OKR-Cell | OKR-Cell: Open World Knowledge Aided Single-Cell Foundation Model with Robust Cross-Modal Cell-Language Pre-training | Open-world knowledge-enhanced single-cell foundation model with robust cross-modal cell-language pretraining. | [arXiv](https://arxiv.org/abs/2601.05648) |
| GeneJepa | GeneJepa: A Predictive World Model of the Transcriptome | Predictive world model for transcriptomics based on JEPA architecture. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.10.14.682378) |
| VCWorld | VCWorld: Biological world model for virtual cell simulation | Biological world model for simulating virtual cell dynamics and perturbation responses. | [arXiv](https://doi.org/10.48550/arxiv.2512.00306) |
| CellForge | CellForge: Agentic Design of Virtual Cell Models | Agentic AI framework for automated design of virtual cell models. | [arXiv](https://arxiv.org/abs/2508.02276) |
| CellHermes | Language may be all omics needs: Harmonizing multimodal data for omics understanding with CellHermes | Multimodal data harmonization model for unified omics understanding. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.11.07.687322) |
| CellTok | CellTok: Early-Fusion Multimodal Large Language Model for Single-Cell Transcriptomics via Tokenization | Early-fusion multimodal LLM for single-cell transcriptomics using gene expression tokenization. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.10.22.684047) |
| sciLaMA | sciLaMA: A Single-Cell Representation Learning Framework to Leverage Prior Knowledge from Large Language Models | Single-cell representation learning leveraging prior knowledge from large language models. | [ICML 2025](https://proceedings.mlr.press/v267/hu25aa.html) |
| CASSIA | CASSIA: a multi-agent large language model for automated and interpretable cell annotation | Multi-agent LLM system for automated and interpretable single-cell annotation. | [Nature Communications](https://www.nature.com/articles/s41467-025-67084-x) |
| scConcept | scConcept: Contrastive pretraining for technology-agnostic single-cell representations beyond reconstruction | Contrastive pretraining framework for technology-agnostic single-cell representations. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.10.14.682419) |
| scLinguist | scLinguist: A pre-trained hyena-based foundation model for cross-modality translation in single-cell multi-omics | Hyena-based foundation model for cross-modality translation in single-cell multi-omics. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.09.30.679123) |
| scNET | scNET: learning context-specific gene and cell embeddings by integrating single-cell gene expression data with protein–protein interactions | Context-specific gene and cell embeddings integrating scRNA-seq with protein-protein interaction networks. | [Nature Methods](https://www.nature.com/articles/s41592-025-02627-0) |
| HEIMDALL | Heimdall: A Modular Framework for Tokenization in Single-Cell Foundation Models | Modular framework for flexible tokenization strategies in single-cell foundation models. | [PMC (bioRxiv)](https://pmc.ncbi.nlm.nih.gov/articles/PMC12642435/) |
| PertAdapt | PertAdapt: Unlocking Single-Cell Foundation Models for Genetic Perturbation Prediction via Condition-Sensitive Adaptation | Method for unlocking single-cell foundation models for genetic perturbation prediction tasks. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.11.21.689655) |
| scPEFT | Harnessing the power of single-cell large language models with parameter-efficient fine-tuning using scPEFT | Parameter-efficient fine-tuning methods tailored for single-cell large language models. | [Nature Machine Intelligence](https://www.nature.com/articles/s42256-025-01170-z) |
| scLAMBDA | Modeling and predicting single-cell multi-gene perturbation responses with scLAMBDA | Model for predicting single-cell responses to multi-gene combinatorial perturbations. | [PubMed (bioRxiv)](https://pubmed.ncbi.nlm.nih.gov/39677694/) |
...
| Stack | Stack: In-Context Learning of Single-Cell Biology | Arc Institute single-cell foundation model trained on 149M human cells enabling zero-shot prediction via in-context learning. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.64898/2026.01.09.698608) |
...
| CellFluxV2 | CellFluxV2 : An Image Generative Foundation Model for Virtual Cell Modeling | Flow matching-based generative foundation model for virtual cell image modeling. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.64898/2026.01.19.696785) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| Xpressor | Towards foundation models that learn across biological scales | Cross-scale learning framework integrating molecular, cellular, and tissue-level gene expression via cross-attention. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.05.16.653447) |
...
| AIDO.Protein | Mixture of Experts Enable Efficient and Effective Protein Understanding and Design | 16B-parameter mixture-of-experts protein module trained on 1.2 trillion amino acids within the AIDO ecosystem. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.11.29.625425) |
| AIDO.ModelGenerator | Rapid and Reproducible Multimodal Biological Foundation Model Development with AIDO.ModelGenerator | Open-source toolkit for accelerating cross-scale multimodal biological foundation model development. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.06.30.662437) |
...
| BALM | Accurate Prediction of Antibody Function and Structure Using Bio-Inspired Antibody Language Model | Bio-inspired antibody language model for predicting antibody structure and function. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2023.08.30.555473) |
...
| FAbCon | A generative foundation model for antibody sequence understanding | 2.4B-parameter generative foundation model for antibody sequence understanding. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.05.22.594943) |
| S2ALM | S2ALM: Sequence-Structure Pre-trained Large Language Model for Comprehensive Antibody Representation Learning | Sequence-structure pretrained large language model for comprehensive antibody understanding. | [Research](https://doi.org/10.34133/research.0721) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| IgGM | A Generative Foundation Model for Antibody Design | Generative foundation model for comprehensive antibody design. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.09.12.675771) |
| DiffAb | Antigen-Specific Antibody Design and Optimization with Diffusion-Based Generative Models | Diffusion-based generative model for antigen-specific antibody CDR-H3 design, jointly modeling sequence, structure, and orientation. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2022.07.10.499510) |
...
| Ophiuchus-Ab | Ophiuchus-Ab: A Versatile Generative Foundation Model for Advanced Antibody-Based Immunotherapy | Diffusion language model for antibody immunotherapy and paired antibody repertoire generation. | [Zenodo](https://doi.org/10.5281/zenodo.18478480) |
| NanoAbLLaMA | NanoAbLLaMA: construction of nanobody libraries with protein large language models | LLaMA2-based language model fine-tuned for nanobody (VHH) library construction and design. | [Frontiers in Chemistry](https://doi.org/10.3389/fchem.2025.1545136) |
...
| AbBFN2 | AbBFN2: A flexible antibody foundation model based on Bayesian Flow Networks | Flexible antibody foundation model based on Bayesian flow networks for multi-objective unified modeling. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.04.29.651170) |
...
| CALM | Contrastive learning for antibody-antigen sequence-to-specificity prediction | CALM is a contrastive antibody-antigen sequence model for bidirectional specificity prediction. | [LifeScience.net (bioRxiv)](https://www.lifescience.net/preprints/9870/contrastive-learning-for-antibody-antigen-sequence/) |
...
| SpaFoundation | SpaFoundation: a visual foundation model for spatial transcriptomics | Visual foundation model for spatial transcriptomics using 1.84M histological images. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.08.07.669202) |
...
| SpatialFusion | SpatialFusion: a lightweight multimodal foundation model for spatial niche mapping with pathway-informed local to global context | Lightweight multimodal foundation model integrating gene expression, histopathology, and pathway data. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.64898/2026.03.16.712056) |
...
| scGPT-spatial | scGPT-spatial: Continual Pretraining of Single-Cell FM for Spatial Transcriptomics | Extension of scGPT for spatial transcriptomics via continual pretraining. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.02.05.636714) |
...
| stFormer | stFormer: a foundation model for spatial transcriptomics | Transformer foundation model integrating ligand-receptor interactions into spatial gene representations. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.09.27.615337) |
| STAGE | STAGE: A Foundation Model for Spatial Transcriptomics Analysis via Graph Embeddings with Hierarchical Prototypes | Foundation model using graph embeddings and hierarchical prototypes for spatial transcriptomics. | [ICLR 2026 Submission](https://openreview.net/forum?id=ZGzKckA29U) |
...
| TISSUENARRATOR | TissueNarrator: Generative Modeling of Spatial Transcriptomics with Large Language Models | LLM-based generative modeling framework for spatial transcriptomics data. | [PubMed (bioRxiv)](https://pubmed.ncbi.nlm.nih.gov/41394628/) |
| SpaTranslator | SpaTranslator: A deep generative framework for universal spatial multi-omics cross-modality translation | Deep generative framework for universal cross-modality translation of spatial multi-omics data. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.11.15.688644) |
| SpatialProp | SpatialProp: tissue perturbation modeling with spatially resolved single-cell transcriptomics | Tissue perturbation modeling using spatially resolved single-cell transcriptomics. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.64898/2025.11.30.691355) |
| SWITCH | Integrative deep learning of spatial multi-omics with SWITCH | Integrative deep learning framework for spatial multi-omics data analysis. | [Nature Computational Science](https://www.nature.com/articles/s43588-025-00891-w) |
| CancerSTFormer | CancerSTFormer enables multi-scale analysis of spot-resolution spatial transcriptomes and dissects the gene and immune regulatory responses of targeted therapies | Multi-scale spatial transcriptomics foundation model for cancer at 50µm and 250µm resolution. | [LifeScience.net (bioRxiv)](https://www.lifescience.net/preprints/4961/cancerstformer-enables-multi-scale-analysis-of-spo/) |
...
| BrainBeacon | BrainBeacon: A Cross-Species Foundation Model for Single-cell Spatial Transcriptomics of Brain | Cross-species brain spatial transcriptomics foundation model integrating multi-species data for digital twin brain. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.07.08.663729) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| GlycanGT | GlycanGT: A Foundation Model for Glycan Graphs with Pretrained Representation and Generative Learning | First glycan graph foundation model using graph transformer for glycan representation and generative learning. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.64898/2025.12.14.694171) |
...
| SweetNet | Using graph convolutional neural networks to learn a representation for glycans | Graph convolutional neural network for glycan representation learning handling complex branching structures. | [Cell Reports](https://doi.org/10.1016/j.celrep.2021.109251) |
| GlycoBERT | Transformer-based Deep Learning for Glycan Structure Inference from MS/MS | BERT-based transformer for inferring glycan structures from tandem mass spectrometry data. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.07.02.662857) |
...
| MGM | MGM as a large-scale pretrained foundation model for microbiome analyses in diverse contexts | Large-scale microbiome foundation model trained on >263,000 microbiome samples for diverse contexts. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.12.30.630825) |
| BiomeGPT | BiomeGPT: A foundation model for the human gut microbiome | Transformer-based human gut microbiome foundation model trained on >13,300 metagenomic samples. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.64898/2026.01.05.697599) |
| GenomeOcean | GenomeOcean: Efficiently Training a Foundation Model with Large Scale Metagenomics Data | Efficient 4B-parameter genome foundation model trained on large-scale metagenomic assemblies (>600 Gbp). | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.01.30.635558) |
...
| Generanno | Gener anno : A Genomic Foundation Model for Metagenomic Annotation | Genomic foundation model for metagenomic annotation trained on 715B prokaryotic base pairs. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.06.04.656517) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| Phyla | Phyla: Towards a Foundation Model for Phylogenetic Inference | First phylogenetic inference foundation model using hybrid state-space transformer with tree loss function. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.01.17.633626) |
...
| OmniNA | OmniNA: A foundation model for nucleotide sequences | Nucleotide sequence foundation model pretrained on >91.7M sequences (>1 trillion bases) for cross-species understanding. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.01.14.575543) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| CpGPT | CpGPT: a Foundation Model for DNA Methylation | DNA methylation foundation model predicting CpG site methylation states for aging and disease research. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.10.24.619766) |
| MethylGPT | MethylGPT: a foundation model for the DNA methylome | DNA methylome foundation model pretrained on large-scale methylation data for epigenetic age prediction and cancer classification. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.10.30.621013) |
| scDNAm-GPT | scDNAm-GPT: a foundation model for single-cell DNA methylation analysis | Single-cell DNA methylation analysis foundation model for resolving epigenetic heterogeneity at single-cell resolution. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.02.19.638959) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| DIA-BERT | DIA-BERT: A Foundation Model for Data-Independent Acquisition Proteomics | Transformer-based foundation model for data-independent acquisition proteomics, improving peptide identification and quantification. | [arXiv](https://arxiv.org/abs/2403.17860) |
...
| LSM-MS2 | LSM-MS2: A Foundation Model Bridging Spectral Identification and Biological Interpretation | Large-scale tandem mass spectrometry foundation model pretrained on millions of MS2 spectra for compound identification. | [arXiv](https://arxiv.org/abs/2510.26715) |
| OmniNovo | Accurate de novo sequencing of the modified proteome with OmniNovo | Universal foundation model for de novo peptide sequencing directly from mass spectrometry data. | [arXiv](https://arxiv.org/abs/2512.12272) |
...
| ChemBERTa-3 | ChemBERTa-3: An Open Source Training Framework for Chemical Foundation Models | Open-source training framework extending the ChemBERTa series for building chemical foundation models. | [Digital Discovery](https://doi.org/10.1039/D5DD00348B) |
...
| Uni-Mol | Uni-Mol: A Universal 3D Molecular Representation Learning Framework | Universal 3D molecular representation learning framework that directly leverages molecular 3D structures for pretraining and achieves SOTA on property prediction. | [ICLR](https://doi.org/10.26434/chemrxiv-2022-jjm0j-v4) |
...
| SMI-TED | SMI-TED: Large-Scale Foundation Model for Materials and Chemistry | Large-scale SMILES encoder-decoder foundation model from IBM, self-supervised on 91M PubChem SMILES for chemistry and materials science. | [Nature Chemistry](https://doi.org/10.1038/s42004-025-01585-0) |
...
| SAFE-GPT | SAFE: A Molecular-Centric Foundation Model with SAFE Representation | Foundation model using Sequential Attachment-based Fragment Embedding (SAFE) molecular representation for generative chemistry. | [Digital Discovery](https://pubs.rsc.org/en/content/articlehtml/2024/dd/d4dd00019f) |
| DrugGPT | DrugGPT: A GPT-based Strategy for Designing Potential Ligands Targeting Specific Proteins | GPT-based drug design model that generates drug-like molecules targeting specific protein binding pockets. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2023.06.29.543848) |
...
| RetroSynFormer | Retrosynformer: planning multi-step chemical synthesis routes via a decision transformer | Decision Transformer for multi-step retrosynthetic planning that models retrosynthesis as a sequence prediction problem. | [Digital Discovery](https://pubs.rsc.org/en/content/articlehtml/2025/dd/d5dd00153f) |
...
| LigUnity | A Foundation Model for Protein-Ligand Affinity Prediction Through Unified Representation | Unified representation learning foundation model for protein-ligand affinity prediction supporting both virtual screening and lead optimization. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.02.17.638554) |
| PhysDock | PhysDock: A Physics-Guided All-Atom Diffusion Model for Protein-Ligand Complex Prediction | Physics-guided all-atom diffusion model for protein-ligand complex prediction integrating detailed atomic-level flexibility modeling. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.04.28.650887) |
| Boltz-2 | Boltz-2: Towards Accurate and Efficient Binding Affinity Prediction | Advanced model for accurate and efficient protein-ligand binding affinity prediction building on AlphaFold3 and Boltz-1 architectures. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.06.14.659707) |
...
| LEFTNet | A new perspective on building efficient and expressive 3D equivariant graph neural networks | Local equivariant frame Transformer network achieving efficient and expressive 3D equivariant graph neural networks through local reference frames. | [NeurIPS 2023](https://arxiv.org/abs/2304.04757) |
| ViSNet | ViSNet: An Equivariant Geometry-Enhanced Graph Neural Network with Vector-Scalar Interactive Message Passing | Equivariant geometry-enhanced GNN with vector-scalar interactive message passing that avoids expensive higher-order tensor operations via runtime geometric computation. | [arXiv](https://arxiv.org/abs/2210.16518) |
...
| REINVENT 4 | Reinvent 4: Modern AI-driven generative molecule design | Fourth-generation industrial molecular design platform from AstraZeneca integrating reinforcement learning, transfer learning, and multi-objective optimization. | [Journal of Cheminformatics](https://link.springer.com/article/10.1186/s13321-024-00812-5) |
...
| NExT-Mol | NExT-Mol: 3D Diffusion Meets 1D Language Modeling for 3D Molecule Generation | Foundation model integrating 1D SELFIES language modeling with 3D diffusion for 3D molecule generation. | [ICLR 2025](https://openreview.net/forum?id=p66a00KLWN) |
...
| AIMNet2 | AIMNet2: a neural network potential to meet your neutral, charged, organic, and elemental-organic needs | Highly transferable neural network potential supporting neutral and charged organic molecules across 14 elements. | [Chemical Science](https://pubs.rsc.org/en/content/articlelanding/2025/sc/d4sc08572h) |
| GRACE | Graph Atomic Cluster Expansion for Semilocal Interactions beyond Equivariant Message Passing | Universal MLIP framework based on graph atomic cluster expansion, covering 97 elements. | [Phys. Rev. X](https://journals.aps.org/prx/abstract/10.1103/PhysRevX.14.021036) |
...
| PET-MAD | PET-MAD as a lightweight universal interatomic potential for advanced materials modeling | Lightweight universal interatomic potential covering the full periodic table for advanced materials simulations. | [Nature Communications](https://www.nature.com/articles/s41467-025-65662-7) |
| Grappa | Grappa – a machine learned molecular mechanics force field | E(3)-equivariant neural network approach to machine-learned molecular mechanics force fields. | [Chemical Science](https://pubs.rsc.org/en/content/articlelanding/2025/sc/d4sc05465b) |
...
| SMI-TED | SMI-TED: Large-Scale Foundation Model for Materials and Chemistry | IBM large-scale SMILES encoder-decoder model pre-trained on 91M PubChem SMILES for materials and chemistry applications. | [Nature Chemistry](https://doi.org/10.1038/s42004-025-01585-0) |
...
| CrystalFormer | Space group informed transformer for crystalline materials generation | Autoregressive Transformer guided by space group symmetry and Wyckoff positions for crystalline materials generation. | [Science Bulletin](https://doi.org/10.1016/j.scib.2025.09.035) |
...
| PotNet | Complete and Efficient Graph Transformers for Crystal Material Property Prediction | Complete and efficient crystal graph Transformer achieving full graph representation via interatomic potential information. | [ICLR](https://arxiv.org/abs/2403.11857) |
...
| CLOUD | CLOUD: A Scalable and Physics-Informed Foundation Model for Crystal Representation Learning | Scalable physics-informed crystal representation foundation model trained on 6M+ crystal structures. | [Nature Communications](https://doi.org/10.1038/s41467-026-70467-3) |
| LLaMat | A family of large language models for materials research with insights into model adaptability in continued pretraining | Family of large language models adapted for materials science tasks. | [Nature Machine Intelligence](https://www.nature.com/articles/s42256-026-01199-8) |
...
| ATOMICA | Learning Universal Representations of Intermolecular Interactions with ATOMICA | Geometric deep learning model learning universal atomic-level representations of intermolecular interactions. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2025.04.02.646906) |
...
| SyMat | Towards Symmetry-Aware Generation of Periodic Materials | Symmetry-aware periodic material generation model explicitly leveraging space group symmetry constraints. | [NeurIPS 2023](https://arxiv.org/abs/2307.02707) |
...
| Matra-Genoa | Autoregressive generative material Transformer | Autoregressive Transformer for generative materials design. | [npj Computational Materials](https://www.nature.com/articles/s41524-025-01940-8) |
...
| CatDRX | Reaction-conditioned generative model for catalyst design and optimization with CatDRX | Reaction-conditioned generative model for designing catalysts tailored to specific reactions. | [Communications Chemistry](https://www.nature.com/articles/s42004-025-01732-7) |
...
| MACE-H | Equivariant electronic Hamiltonian prediction with many-body message passing | MACE-based equivariant GNN for predicting electronic Hamiltonians. | [npj Computational Materials](https://www.nature.com/articles/s41524-026-02020-1) |
...
| POLYT5 | POLYT5: an encoder-decoder foundation chemical language model for generative polymer design | T5 encoder-decoder foundation chemical language model for polymer design. | [npj Artificial Intelligence](https://www.nature.com/articles/s44387-026-00087-1) |
...
| DimeNet | Directional Message Passing for Molecular Graphs | Directional message passing network using bond angle information for 3D geometry-aware molecular property prediction. | [ICLR](https://arxiv.org/abs/2003.03123) |
...
| OmniLearned | Foundation model framework for all tasks involving jet physics | Upgraded OmniLearn framework trained on 1B+ jet events with Transformer architecture for jet classification, regression, and generation. | [Physical Review D](https://doi.org/10.1103/knmd-f5jm) |
| OmniJet-α | OmniJet-α: the first cross-task foundation model for particle physics | First cross-task particle physics foundation model supporting both jet generation and jet tagging. | [Machine Learning: Science and Technology](https://doi.org/10.1088/2632-2153/ad66ad) |
...
| JetCLR | Symmetries, safety, and self-supervision | Contrastive self-supervised jet representation learning framework using permutation-invariant Transformer encoder with symmetry augmentation. | [arXiv](https://arxiv.org/abs/2108.04253) |
...
| PDE-Transformer | PDE-Transformer: Efficient and Versatile Transformers for Physics Simulations | Scalable Transformer architecture for efficient surrogate modeling across multiple PDE types on regular grids. | [PMLR / ICML 2025](https://proceedings.mlr.press/v267/holzschuh25a.html) |
...
| X-MeshGraphNet | X-MeshGraphNet: Scalable Multi-Scale Graph Neural Networks for Physics Simulation | NVIDIA multi-scale mesh graph network extending MeshGraphNets to large-scale industrial physics simulation. | [arXiv](https://arxiv.org/abs/2411.17164) |
| AI-HAMILTON | AI-HAMILTON: Leveraging In-Context Learning for Modeling Hamiltonian Systems | Framework for learning Hamiltonian systems from data with in-context learning and symmetry-aware priors. | [OpenReview](https://openreview.net/forum?id=t9itJDrZwy) |
...
| GameNGen | Diffusion Models Are Real-Time Game Engines | Google Research neural game engine using diffusion models to simulate complex game environments (DOOM) at 20+ fps. | [arXiv](https://arxiv.org/abs/2408.14837) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| FNQS | Foundation Model for Quantum Many-Body States via Transformers | Transformer-based foundation model pre-trained on quantum state data, generalizing across different Hamiltonians and lattice structures. | [Nature Communications](https://www.nature.com/articles/s41467-025-62098-x) |
| Attention-Based FM for Quantum States | Attention-Based Foundation Model for Quantum States | Attention-based foundation model using self-attention to capture quantum correlations for cross-system quantum state representation. | [arXiv](https://arxiv.org/abs/2512.11962) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| Skala | Accurate and scalable exchange-correlation with deep learning | Microsoft quantum chemistry foundation model for electronic structure computation and cross-system molecular property prediction. | [arXiv](https://arxiv.org/abs/2506.14665) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| Aurora | A foundation model for the Earth system | A large-scale earth system foundation model by Microsoft trained on over one million hours of multi-source geophysical data for atmosphere, ocean, and air quality prediction. | [Nature 2025](https://www.nature.com/articles/s41586-025-09005-y) |
| Pangu-Weather | Accurate medium-range global weather forecasting with 3D neural networks | A 3D high-resolution AI weather forecasting model by Huawei trained on 43 years of ERA5 reanalysis data, generating 10-day global forecasts in seconds. | [Nature](https://doi.org/10.1038/s41586-023-06185-3) |
| GraphCast | Learning skillful medium-range global weather forecasting | A graph neural network-based global medium-range weather forecasting model by Google DeepMind at 0.25° resolution, outperforming ECMWF HRES for 10-day forecasts. | [Science 2023](https://doi.org/10.1126/science.adi2336) |
| GenCast | Probabilistic weather forecasting with machine learning | A diffusion-based ensemble weather forecasting system by Google DeepMind generating probabilistic 15-day forecasts that surpass ECMWF ENS. | [Nature 2025](https://www.nature.com/articles/s41586-024-08252-9) |
| ClimaX | ClimaX: A foundation model for weather and climate | The first weather and climate foundation model based on Transformer architecture supporting flexible fine-tuning for multiple downstream meteorological tasks. | [PMLR 2023](https://proceedings.mlr.press/v202/nguyen23a.html) |
...
| FuXi | FuXi: a cascade machine learning forecasting system for 15-day global weather forecast | A cascade machine learning weather forecasting system trained on 39 years of ERA5 data, achieving 15-day forecast performance comparable to ECMWF ensemble mean. | [npj Climate and Atmospheric Science](https://www.nature.com/articles/s41612-023-00512-1) |
...
| Stormer | Scaling transformer neural networks for skillful and reliable medium-range weather forecasting | A streamlined and efficient Transformer weather forecasting model achieving state-of-the-art performance with less training data. | [NeurIPS 2024](https://nips.cc/virtual/2024/poster/94582) |
...
| WeatherGFT | WeatherGFT: Generalizing Weather Forecast to Fine-grained Temporal Scales via Physics-AI Hybrid Modeling | A hybrid physics-AI weather forecasting model extending predictions to finer temporal resolutions at 30-minute intervals. | [NeurIPS 2024](https://proceedings.neurips.cc/paper_files/paper/2024/hash/298c3e32d7d402189444be2ff5d19979-Abstract-Conference.html) |
| WeatherGFM | WeatherGFM: Learning a Weather Generalist Foundation Model via In-context Learning | A weather generalist foundation model unifying forecasting, super-resolution, image translation, and post-processing via in-context learning. | [ICLR 2025](https://proceedings.iclr.cc/paper_files/paper/2025/hash/c897d8f3be030344949de9bd93d8274e-Abstract-Conference.html) |
...
| SatCLIP | SatCLIP: Global, General-Purpose Location Embeddings with Satellite Imagery | A global general-purpose location encoder by Microsoft using Sentinel-2 contrastive learning to generate location embeddings. | [AAAI 2025](https://ojs.aaai.org/index.php/AAAI/article/view/32457) |
| SkySense | SkySense: A Multi-Modal Remote Sensing Foundation Model Towards Universal Interpretation for Earth Observation Imagery | A large-scale multimodal remote sensing foundation model pre-trained on 21.5 million temporal optical and SAR data samples. | [CVPR 2024](https://openaccess.thecvf.com/content/CVPR2024/html/Guo_SkySense_A_Multi-Modal_Remote_Sensing_Foundation_Model_Towards_Universal_Interpretation_CVPR_2024_paper.html) |
| Scale-MAE | Scale-MAE: A Scale-Aware Masked Autoencoder for Multiscale Geospatial Representation Learning | A scale-aware masked autoencoder that explicitly models spatial resolution relationships for multiscale geospatial representation learning. | [ICCV 2023](https://openaccess.thecvf.com/content/ICCV2023/html/Reed_Scale-MAE_A_Scale-Aware_Masked_Autoencoder_for_Multiscale_Geospatial_Representation_Learning_ICCV_2023_paper.html) |
...
| S2MAE | S2MAE: A Spatial-Spectral Pretraining Foundation Model for Spectral Remote Sensing Data | A spatial-spectral masked autoencoder providing joint spatial-spectral pre-training for spectral remote sensing imagery. | [CVPR 2024](https://doi.org/10.1109/CVPR52733.2024.02616) |
...
| AnySat | AnySat: One Earth Observation Model for Many Resolutions, Scales, and Modalities | A unified multi-resolution multimodal earth observation model using JEPA architecture for diverse EO tasks. | [CVPR 2025](https://openaccess.thecvf.com/content/CVPR2025/html/Astruc_AnySat_One_Earth_Observation_Model_for_Many_Resolutions_Scales_and_CVPR_2025_paper.html) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| OceanGPT | OceanGPT: A Large Language Model for Ocean Science Tasks | A domain-specific large language model for ocean science by Zhejiang University using the DoInstruct framework for ocean domain instruction data. | [ACL Anthology](https://aclanthology.org/2024.acl-long.184/) |
...
| ORCA-DL | Data-driven global ocean modeling for seasonal to decadal prediction | A data-driven global ocean model supporting 3D ocean predictions from seasonal to decadal timescales. | [Science Advances 2025](https://doi.org/10.1126/sciadv.adu2488) |
...
| EQCCT | EQCCT: A Production-Ready Earthquake Detection and Phase-Picking Method Using the Compact Convolutional Transformer | A production-ready compact convolutional Transformer for earthquake detection and phase picking. | [IEEE TGRS](https://doi.org/10.1109/TGRS.2023.3319440) |
...
| HydroGAT | HydroGAT: Distributed Heterogeneous Graph Attention Transformer for Spatiotemporal Flood Prediction | A graph attention network-based hydrological prediction foundation model capturing spatial dependencies across watersheds. | [Proceedings of the 33rd ACM International Conference on Advances in Geographic Information Systems](https://doi.org/10.1145/3748636.3764172) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| K2 | K2: A Foundation Language Model for Geoscience Knowledge Understanding and Utilization | The first 7-billion-parameter geoscience LLM based on LLaMA, further pre-trained and instruction-tuned on earth science literature. | [ACM](https://doi.org/10.1145/3616855.3635772) |
| JiuZhou | JiuZhou: open foundation language models and effective pre-training framework for geoscience | A multilingual geoscience LLM by Tsinghua University supporting Chinese and English earth science knowledge QA and reasoning. | [Taylor & Francis](https://www.tandfonline.com/doi/full/10.1080/17538947.2025.2449708) |
| GeoGPT | GeoGPT: An assistant for understanding and processing geospatial tasks | A geospatial AI assistant model combining tool-calling capabilities for geospatial analysis and reasoning. | [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S1569843224003303) |
...
| SAM-Med3D | SAM-Med3D: Towards General-purpose Segmentation Models for Volumetric Medical Images | General-purpose 3D medical image segmentation model supporting multiple anatomical structures and lesions with minimal interactive annotation. | [arXiv](https://arxiv.org/abs/2310.15161) |
...
| BioViL-T | Learning to Exploit Temporal Structure for Biomedical Vision-Language Processing | Microsoft temporal vision-language model for longitudinal chest X-ray analysis and phrase grounding in radiology. | [CVPR 2023](https://openaccess.thecvf.com/content/CVPR2023/html/Bannur_Learning_To_Exploit_Temporal_Structure_for_Biomedical_Vision-Language_Processing_CVPR_2023_paper.html) |
| LVM-Med | LVM-Med: Learning Large-Scale Self-Supervised Vision Models for Medical Imaging via Second-order Graph Matching | Large-scale self-supervised medical imaging vision model trained on ~1.3M multi-modal images (CT/MRI/X-ray/ultrasound). | [NeurIPS 2023](https://openreview.net/forum?id=xE7oH5iVGK) |
...
| UniverSeg | UniverSeg: Universal Medical Image Segmentation | Medical image segmentation model that generalizes to unseen tasks without additional training using in-context learning. | [ICCV 2023](https://openaccess.thecvf.com/content/ICCV2023/html/Butoi_UniverSeg_Universal_Medical_Image_Segmentation_ICCV_2023_paper.html) |
...
| vesselFM | vesselFM: A Foundation Model for Universal 3D Blood Vessel Segmentation | Universal 3D blood vessel segmentation foundation model. | [arXiv](https://doi.org/10.1109/cvpr52734.2025.01944) |
...
| ELIXR | ELIXR: Towards a General-Purpose X-Ray Artificial Intelligence System Through Alignment of Large Language Models and Radiology Vision Encoders | Google system aligning large language models with radiology vision encoders for general-purpose X-ray AI. | [arXiv](https://arxiv.org/abs/2308.01317) |
...
| MedImageInsight | MedImageInsight: An Open-Source Embedding Model for General Domain Medical Imaging | Microsoft open-source medical imaging embedding foundation model covering 14 imaging modalities, supporting multiple downstream tasks. | [arXiv](https://arxiv.org/abs/2410.06542) |
...
| PRISM-MRI | Large-scale Multi-sequence Pretraining for Generalizable MRI Analysis in Versatile Clinical Applications | PRISM multi-sequence MRI foundation model pretrained on 336,476 volumetric scans for diagnosis, segmentation, registration, progression prediction, and report generation. | [arXiv](https://arxiv.org/abs/2508.07165) |
| LLaVA-NeXT-Med | LLaVA-NeXT-Med: Medical Multimodal Large Language Model | Medical multimodal LLM built by pretraining and fine-tuning on LLaVA-NeXT and LLaVA-Med data for medical image analysis and visual question answering. | [CITSC 2025](https://doi.org/10.1109/CITSC64390.2025.00092) |
...
| Ark+ | A fully open AI foundation model applied to chest radiography | Fully open AI foundation model for chest radiography published in Nature. | [Nature](https://www.nature.com/articles/s41586-025-09079-8) |
...
| GenBrain | GenBrain: A Generative Foundation Model of Multimodal Brain Imaging | Large-scale multimodal brain imaging generative foundation model pretrained on ~1.2M 3D MRI scans (44,000+ individuals, 34 imaging modalities). | [medRxiv](https://doi.org/10.21203/rs.3.rs-8404638/v1) |
...
| BrainLM | BrainLM: A foundation model for brain activity recordings | Brain activity foundation model trained on 6,700 hours of fMRI data using self-supervised masked prediction for predicting age, sex, and clinical variables. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2023.09.12.557460) |
...
| BrainGFM | A Brain Graph Foundation Model: Pre-Training and Prompt-Tuning across Broad Atlases and Disorders | Brain graph foundation model using graph contrastive learning and masked autoencoders for fMRI data. | [ICLR 2026](https://openreview.net/forum?id=PeGHkAaRxs) |
...
| MindLLM | MindLLM: A Subject-Agnostic and Versatile Model for fMRI-to-Text Decoding | Subject-agnostic fMRI-to-text decoding model advancing brain-computer interface research. | [ICML 2025](https://icml.cc/virtual/2025/poster/45933) |
...
| Virchow2 | Virchow2: Scaling Self-Supervised Mixed Magnification Models in Pathology | Second-generation Virchow including Virchow2 (632M params) and Virchow2G (1.85B params), trained at mixed magnifications. | [arXiv](https://arxiv.org/abs/2408.00738) |
...
| Phikon | Scaling Self-Supervised Learning for Histopathology with Masked Image Modeling | Owkin histopathology self-supervised foundation model using iBOT framework trained on large-scale pathology data. | [Sciety (medRxiv)](https://sciety.org/articles/activity/10.1101/2023.07.21.23292757) |
...
| CHIEF | A pathology foundation model for cancer diagnosis and prognosis prediction | Universal clinical histopathology AI system pretrained on 60,000+ WSIs (19 anatomical sites), supporting cancer detection, grading, and molecular marker prediction. | [Nature](https://www.nature.com/articles/s41586-024-07894-z) |
...
| MUSK | A vision–language foundation model for precision oncology | Precision oncology vision-language foundation model supporting multimodal cancer diagnosis and prognosis prediction. | [Nature](https://doi.org/10.1038/s41586-024-08378-w) |
...
| BEPH | A foundation model for generalizable cancer diagnosis and survival prediction from histopathological images | BEiT-based histopathology foundation model pretrained on 11 million unlabeled image patches for cancer diagnosis and survival prediction. | [Nature Communications](https://www.nature.com/articles/s41467-025-57587-y) |
...
| COBRA | Unsupervised Foundation Model-Agnostic Slide-Level Representation Learning | Slide-level pathology representation learning method that integrates embeddings from multiple foundation models and uses the COBRA contrastive pretraining strategy. | [CVPR 2025](https://openaccess.thecvf.com/content/CVPR2025/html/Lenz_Unsupervised_Foundation_Model-Agnostic_Slide-Level_Representation_Learning_CVPR_2025_paper.html) |
| THREADS | Molecular-driven Foundation Model for Oncologic Pathology | Multimodal slide-level oncology pathology foundation model pretrained on 47,171 H&E slides paired with genomic and transcriptomic profiles. | [arXiv](https://arxiv.org/abs/2501.16652) |
...
| Lunit-DINO | Benchmarking Self-Supervised Learning on Diverse Pathology Datasets | Lunit's DINOv2-based large-scale pathology pretraining. | [arXiv](https://doi.org/10.1109/cvpr52729.2023.00326) |
...
| Path Foundation | Domain-specific optimization and diverse evaluation of self-supervised models for histopathology | Google-developed pathology foundation model. | [arXiv](https://arxiv.org/abs/2310.13259) |
...
| GigaSSL | Giga-SSL: Self-Supervised Learning for Gigapixel Images | Slide-level self-supervised learning method for pathology whole-slide images that learns task-agnostic gigapixel embeddings from unlabeled WSIs. | [CVPR Workshops 2023](https://openaccess.thecvf.com/content/CVPR2023W/CVMI/html/Lazard_Giga-SSL_Self-Supervised_Learning_for_Gigapixel_Images_CVPRW_2023_paper.html) |
...
| GenBio-PathFM | GenBio-PathFM: A State-of-the-Art Foundation Model for Histopathology | 1.1B-parameter state-of-the-art histopathology foundation model fully trained on public data. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.64898/2026.03.17.712534) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| Med-PaLM | Large Language Models Encode Clinical Knowledge | Google's first medical LLM, achieving expert-level performance on medical question answering benchmarks by encoding clinical knowledge in a large language model. | [Nature](https://www.nature.com/articles/s41586-023-06291-2) |
...
| GatorTron | A large language model for electronic health records | Large-scale clinical language model (up to 8.9B parameters) pretrained on over 90 billion words of clinical text, designed to unlock patient information from unstructured EHRs. | [npj Digital Medicine](https://www.nature.com/articles/s41746-022-00742-2) |
| BioGPT | BioGPT: generative pre-trained transformer for biomedical text generation and mining | Domain-specific generative Transformer pretrained on large-scale biomedical literature for both text generation and mining tasks in biomedicine. | [Briefings in Bioinformatics](https://academic.oup.com/bib/article/23/6/bbac409/6713511) |
| PMC-LLaMA | PMC-LLaMA: toward building open-source language models for medicine | Open-source medical LLM fine-tuned on PubMed Central papers, enabling accessible medical language understanding and generation. | [JAMIA](https://academic.oup.com/jamia/article/31/9/1833/7645318) |
...
| ClinicalBERT | ClinicalBERT: Modeling Clinical Notes and Predicting Hospital Readmission | BERT model adapted for clinical notes, pretrained on clinical text to learn patient representations for hospital readmission prediction and other clinical tasks. | [arXiv](https://arxiv.org/abs/1904.05342) |
...
| MetaReact | MetaReact: A Reaction-Aware Transformer for End-to-End Prediction of Drug Metabolism | Reaction-aware Transformer for predicting drug metabolism pathways, integrating chemical reaction knowledge into drug metabolism modeling. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.64898/2026.03.14.711529) |
...
| PVLens | PVLens: Enhancing Pharmacovigilance Through Automated Label Extraction | GSK-developed automated pipeline for extracting adverse drug reactions from FDA drug labels and mapping them to MedDRA terminology. | [arXiv](https://arxiv.org/abs/2503.20639) |
...
| CLEAR | CLEAR: An Auditable Foundation Model for Radiology Grounded in Clinical Concepts | Auditable radiology foundation model trained on ~870K chest X-ray image-report pairs, grounding predictions in explicit clinical concepts for transparency. | [Sciety (medRxiv)](https://sciety.org/articles/activity/10.64898/2026.01.15.26344222) |
...
| DF5T | A foundation AI model enhances electron microscopy image analysis | Unsupervised electron microscopy foundation model supporting five tasks: denoising, deblurring, super-resolution, 2D inpainting, and 3D isotropic restoration. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.64898/2026.02.28.708664) |
...
| Model | Paper Title | Description | Link |
|-------|------------|-------------|------|
| AgriGPT | AgriGPT: A Strong Plant Disease Detection Model via Visual-Language Model | A multimodal AI model integrating visual and text data for precise plant disease detection and crop health assessment. | [Lecture Notes in Computer Science](https://doi.org/10.1007/978-981-96-9921-6_20) |
...
| SoilNet | SoilNet: A multimodal multitask model for hierarchical classification of soil horizons | A multimodal soil horizon classification foundation model integrating soil images, chemical, and physical property data. | [Geoderma](https://doi.org/10.1016/j.geoderma.2026.117684) |
...
| NicheFlow | NicheFlow: A Generative Foundation Model for Species Distribution Modeling | The first generative flow matching-based foundation model for species distribution modeling, learning continuous environment-species relationships. | [Sciety (bioRxiv)](https://sciety.org/articles/activity/10.1101/2024.10.15.618541) |
| Granite-Geospatial-Ocean | A Sentinel-3 foundation model for ocean colour | A Sentinel-3 ocean-colour foundation model in the Granite geospatial family for ocean monitoring and downstream marine tasks. | [arXiv](https://arxiv.org/abs/2509.21273) |
...
| FMRAG | FMRAG: Retrieval-Augmented Multimodal Large Language Models for Fisheries Intelligence | A retrieval-augmented multimodal large language model framework for fisheries intelligence supporting knowledge-grounded marine science QA. | [Frontiers in Marine Science](https://www.frontiersin.org/journals/marine-science/articles/10.3389/fmars.2026.1801835/full) |
