...
| PROSE-PDE | Towards a Foundation Model for Partial Differential Equations: Multi-Operator Learning and Extrapolation | Multimodal PDE foundation model supporting multi-operator learning, extrapolation, and equation identification. | [Phys. Rev. E](https://doi.org/10.1103/physreve.111.035304) |
...
| PINO | Physics-Informed Neural Operator for Learning Partial Differential Equations | Physics-informed neural operator combining data-driven and physical constraint losses to learn PDE solution operators with minimal labeled data. | [ACM / IMS Journal of Data Science](https://doi.org/10.1145/3648506) |
