...
| LeanDojo-v2 | LeanDojo-v2: Advanced AI-Assisted Theorem Proving for Lean 4 | An upgraded LeanDojo integrating repository tracking, dataset management, retrieval-augmented agents, and LLMs for Lean 4. | [GitHub](https://github.com/lean-dojo/LeanDojo) |
...
| NuminaMath | NuminaMath: AI Mathematical Olympiad (AIMO) Prize Winning Solution | The winning solution for the 1st AIMO Progress Prize using tool-integrated reasoning strategies to solve competition-level math problems. | [Hugging Face](https://huggingface.co/blog/winning-aimo-progress-prize) |
...
| Skywork-Math | Skywork-Math: Data Scaling Laws for Mathematical Reasoning in Large Language Models | A study exploring data scaling laws for mathematical reasoning in LLMs, providing guidance for math LLM training. | [arXiv](https://arxiv.org/abs/2407.08348) |
